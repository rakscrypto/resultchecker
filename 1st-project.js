// Sample student data (in a real app, this should come from a server or database)
const students = [
    { id: "FSC/CSC/2200399", name: "Rakin Momodu Oshioke", results: [
    ...
    { id: "FSC/CSC/2200400", name: "Grace Ezechi", results: [
    ...
    { id: "FSC/CSC/2200401", name: "Emeka Okafor", results: [
    ...
    { id: "FSC/CSC/2200402", name: "Fatima Yusuf", results: [
    ...
    { id: "FSC/CSC/2200403", name: "Tunde Adebayo", results: [
    ...
    { id: "FSC/CSC/2200404", name: "Amaka Umeh", results: [
    ...
    { id: "FSC/CSC/2200405", name: "Ibrahim Danjuma", results: [
    ...
    { id: "FSC/CSC/2200406", name: "Chidinma Nwosu", results: [
...
function checkResult() {
    ...
    if (!id) {
        alert("Please enter a valid MAT-NO.");
        return;
    }
